...
- **P4 Foundational Architecture** -> Architect Descartes. Signals: "schema", "data model", "system design", "security model", "types", "from scratch", "new service", "scaffold", "bootstrap". Boost: "trust boundaries", "data constraints", "bedrock".
