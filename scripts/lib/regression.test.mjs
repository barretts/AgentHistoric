...
test("evaluateResponse rejects blended headings from another expert", async () => {
  ...
  const response = {
    ...
    response: [
      "Selected Expert: expert-architect-descartes",
      "Reason: VERIFIED the prompt asks for contracts.",
      "Confidence: High",
      "Assumptions: VERIFIED some interfaces are unknown.",
      "Failure Modes: VERIFIED missing auth rules break the design.",
      "Draft A: Explore a looser API-first option."
    ].join("\n")
  };
