...
SRC_CLAUDE="$REPO_DIR/.claude/rules"
SRC_CURSOR="$REPO_DIR/.cursor/rules"
SRC_CURSOR_RICH="$REPO_DIR/.cursor/rules/rich"
SRC_CURSOR_GPT="$REPO_DIR/.cursor/rules/gpt"
SRC_WINDSURF="$REPO_DIR/.windsurf/rules"
SRC_WINDSURF_RICH="$REPO_DIR/.windsurf/rules/rich"
SRC_WINDSURF_GPT="$REPO_DIR/.windsurf/rules/gpt"
SRC_CODEX="$REPO_DIR/.codex"
...
print_post_install() {
  ...
  for target in "$@"; do
    case "$target" in
      ...
      codex)
        echo "  Codex"
        echo "    AGENTS.md and skills/ are loaded automatically from ~/.codex/."
